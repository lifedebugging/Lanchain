# Drawbacks of Janus v1
*Janus V1* is my first version and the mess I created in the name of Project. I was happy and ~grinning~ after *Janus V1* script successful output.

As I advanced learning about agents and stuctured output. I realized Janus is incomplete in many ways. Hence, the creation of *Janus v2* 

In Janus v2 I addressed following drawbacks:
